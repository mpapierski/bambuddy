export default {
  ...
  slice: {
    ...
    allPlatesHint: 'Slice every plate in this 3MF',
    selectPlate: 'Select plate to slice',
    selectPlateHint: 'Pick a plate to slice, or choose All plates.',
    ownedDeviceKindsOnly: 'Owned device kinds only',
    noOwnedDeviceKinds: 'No owned device kinds with profiles',
    filamentSlot: 'Filament {{index}} ({{type}})',
    embeddedFilaments: '3MF filament profiles',
    embeddedFilamentProfile: 'Embedded profile',
    advanced: 'Advanced',
    overrideFilaments: 'Override filament profiles',
    useEmbeddedFilaments: 'Use 3MF filament profiles',
    ...
    printerMismatch: 'This 3MF was prepared for {{source}}, but you picked {{target}}. Bambuddy will ask the slicer to convert it with the selected profiles; if slicing fails, choose a matching device/profile.',
    ...
    printerProcessRequired: 'Printer and process presets must be selected',
    embeddedFilament3mfOnly: 'Embedded filament mode is only available for 3MF sources',
