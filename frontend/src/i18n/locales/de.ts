export default {
  ...
  slice: {
    ...
    allPlatesHint: 'Alle Platten in diesem 3MF slicen',
    selectPlate: 'Platte zum Slicen auswählen',
    selectPlateHint: 'Wähle eine Platte zum Slicen oder Alle Platten.',
    ownedDeviceKindsOnly: 'Nur eigene Gerätetypen',
    noOwnedDeviceKinds: 'Keine eigenen Gerätetypen mit Profilen',
    filamentSlot: 'Filament {{index}} ({{type}})',
    embeddedFilaments: '3MF-Filamentprofile',
    embeddedFilamentProfile: 'Eingebettetes Profil',
    advanced: 'Erweitert',
    overrideFilaments: 'Filamentprofile überschreiben',
    useEmbeddedFilaments: '3MF-Filamentprofile verwenden',
    ...
    printerMismatch: 'Dieses 3MF wurde für {{source}} vorbereitet, aber du hast {{target}} ausgewählt. Bambuddy lässt den Slicer die Konvertierung mit den gewählten Profilen versuchen; falls das Slicen fehlschlägt, wähle ein passendes Gerät/Profil.',
    ...
    printerProcessRequired: 'Drucker- und Prozessprofile müssen ausgewählt sein',
    embeddedFilament3mfOnly: 'Eingebetteter Filamentmodus ist nur für 3MF-Quellen verfügbar',
